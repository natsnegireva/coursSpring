...
//-- Для того чтобы создать JDBC соединение при создании приложения на сервере приложений создадим класс-слушатель
//-- В данном коде мы получаем значения  параметров инициализации из файла web.xml, создаем для них JDBC соединение с базой
//--  данных и сохраняем созданное соединение в атрибутах контекста. В дальнейшем каждый сервлет сможет извлечь
//--  объект-соединение из контекста по названию атрибута.
