...
//-- На практике классы сервлетов непосредственно от javax.servlet.Servlet порождают довольно редко.
//-- Данный интерфейс включает в себя только самые основные методы жизненного цикла сервлета.
//-- Servlet API содержит абстрактный класс javax.servlet.http.HttpServlet, который уже реализует
//-- интерфейс javax.servlet.Servlet и гораздо более удобен для написания сервлетов, работающих по протоколу HTTP.
